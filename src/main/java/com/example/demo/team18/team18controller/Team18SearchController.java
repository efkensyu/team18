...
import com.example.demo.team18.team18service.Team18SearchService;
...
//	検索画面
	...
	public String index (Model model) {	
		...
		return "team18/team18search/team18searchform";		
	}
//	検索結果表示画面	
	...
	public String send (@RequestParam String keyword, Model model) {
		...
		return "team18/team18search/team18searchresult";
	}
}